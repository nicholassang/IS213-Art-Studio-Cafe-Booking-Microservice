...
export default function Cart() {
  ...
  useEffect(() => {
    fetch("http://localhost:8003/food-order/all")
      .then(res => res.json())
  ...
  const handleDelete = async (order_id) => {
    await fetch(`http://localhost:8003/food-order/${order_id}`, { method: "DELETE" });
  ...
  const handleUpdateQuantity = async (order_id, quantity) => {
    ...
    await fetch(`http://localhost:8003/food-order/${order_id}/quantity`, {
      method: "PUT",
